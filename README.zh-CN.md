...
下表是针对本插件实际使用体验的相对评分。`5/5` 始终代表更有利：隐私保护更强、配置更方便、首段启动更快、音色选择更多、对用户付费 API 额度依赖更小或离线能力更强。评分仅用于选型参考，不构成安全性、服务商政策、价格或延迟保证。

| 模式 | 隐私保护 | 配置便利度 | 启动速度 | 音色选择 | API 额度 | 离线能力 |
| --- | :---: | :---: | :---: | :---: | :---: | :---: |
| 本地 CosyVoice | 5/5 | 2/5 | 3/5 | 3/5 | 5/5 | 5/5 |
| Microsoft Edge 在线语音 | 2/5 | 4/5 | 4/5 | 5/5 | 4/5 | 1/5 |
